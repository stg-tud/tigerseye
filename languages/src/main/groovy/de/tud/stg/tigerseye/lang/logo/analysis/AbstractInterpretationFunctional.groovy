 ...
 */ 
public class AbstractInterpretationFunctional extends Interpreter /*implements IFunctional*/ implements DSL {
	protected HashMap<String,Closure> functionNamesToClosure;
		 
	public AbstractInterpretationFunctional() {
		functionNamesToClosure = new HashMap<String,Closure>();
	}
	
	public AbstractInterpretationFunctional(HashMap<String,Closure> enclosedFunctionNamesToClosure) {
		functionNamesToClosure = new HashMap<String,Closure>();
